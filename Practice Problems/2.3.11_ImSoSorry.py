...
should_go = exam or (sunny and ((sunblock and morning_classes) or night_classes) or (raining and rain_jacket) or (snowing and ((friends_are_going and fluffy_coat) or (snow_boots and fluffy_coat) or really_want_to_go)))
